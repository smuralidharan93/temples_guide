const templesData = [
    ...
    },
    {
        ...
        "ID":  "TN021",
        "God":  "Valithayanathar / Vali Nayagar",
        "Goddess":  "Jagadambikai / Thaiyal Nayagi",
        "Sthala_Varalaru":  "Mythology states that Vali worshipped Lord Shiva here, hence the name Thiruvalithayam. Sage Bharadwaja also worshipped here to get relief from a curse. The temple has a unique Gajaprishta Vimana (shaped like an elephant\u0027s back).",
        "Travel_Details":  "Located in Padi, near Ambattur, Chennai. Easily accessible via Chennai-Tiruvallur High Road.",
        "Name_EN":  "Thiruvalithayam"
    },
    {
        "District":  "",
        "Details":  "02. மாசிலாமணீஸ்வரர் - வடதிருமுல்லைவாயில். சென்னையிலிருந்து 26 கி.மீ., - 044 - 2637 6151.",
        "ID":  "TN022",
        "God":  "Masilamaneeswarar",
        "Goddess":  "Kodi Idai Nayagi",
        "Sthala_Varalaru":  "King Thondaiman was travelleing on his elephant which got entangled in jasmine creepers. When he cut the creepers, blood oozed out, revealing a Lingam. He built the temple here. The Lord is self-manifested (Swayambhu).",
        "Travel_Details":  "Located in Vada Thirumullaivayil, near Ambattur/Avadi on the Chennai-Avadi road. Local trains to Thirumullaivayil station available.",
        "Name_EN":  "Vada Thirumullaivayil"
    },
    {
        "District":  "",
        ...
        "God":  "Kapaleeshwarar",
        "Goddess":  "Karpagambal",
        "Sthala_Varalaru":  "Goddess Parvati worshipped Lord Shiva in the form of a peacock (Mayil in Tamil), giving the place the name Mylapore. It is one of the most famous temples in Chennai.",
        "Travel_Details":  "Located in the heart of Mylapore, Chennai. Very well connected by bus and MRTS (Thirumayilai station).",
    ...
    },
    {
        ...
        "Sthala_Varalaru":  "Sage Agastya is said to have been blessed with the marriage vision of Shiva and Parvati here. Sage Valmiki also worshipped here (Vanmiki-Ur became Thiruvanmiyur). The Lord is worshipped as the Healer (Marundeeswarar).",
        "Travel_Details":  "Located in Thiruvanmiyur on the East Coast Road (ECR), Chennai. Major bus terminus and MRTS station nearby.",
    ...
    },
    {
        ...
        "ID":  "TN001",
        "God":  "Ekambareswarar",
        "Goddess":  "Elavar Kuzhali",
        "Sthala_Varalaru":  "Represents the Earth (Prithvi) element among the Pancha Bhoota Sthalams. Goddess Parvati worshipped a Lingam made of sand under a Mango tree. The mango tree here is said to be 3500 years old.",
        "Travel_Details":  "Located in Kanchipuram town, about 75km from Chennai. Kanchipuram is well connected by road and rail.",
        "Name_EN":  "Kanchipuram Ekambareswarar"
    },
    {
        "District":  "",
